        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              ...
              <Link
                href="/login"
                className="group px-8 py-4 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white text-lg font-semibold rounded-xl border border-white/20 transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold">Life Alert</h3>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-gray-400 text-sm mb-4 md:mb-0">
                  © 2024 Life Alert Emergency Response. All rights reserved.
                </p>
