          ...
          html_template: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin-bottom: 20px;">
                ...
                <p style="margin: 10px 0 0 0;">Your emergency contact has activated their Life GuardPro system. This appears to be a critical emergency and emergency services may have been contacted.</p>
              </div>
        ...
        content: {
          ...
          html_template: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin-bottom: 20px;">
                <p style="margin: 0;"><strong>Hello {{contact_name}},</strong></p>
                <p style="margin: 10px 0 0 0;">Your emergency contact has activated their Life GuardPro system. This appears to be a moderate emergency requiring attention.</p>
              </div>
